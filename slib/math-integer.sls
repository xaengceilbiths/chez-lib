...
(library
  ...
  (begin
    ...
    (define quotient-ei  (must-be-exact-integer2 'quotient quotient))
    (define remainder-ei (must-be-exact-integer2 'remainder remainder))
    (define modulo-ei    (must-be-exact-integer2 'modulo modulo))
    ...
    (define (round-quotient num den)
      (define quo (quotient-ei num den))
      (define rem (remainder-ei num den))
