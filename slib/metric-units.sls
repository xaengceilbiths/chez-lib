...
(library
  ...
  (begin
      ...
      (cond
        ...
        ((string? str)
         (let ((len (string-length str)))
           (let ((s1 (and (> len 1)
                          (SI:try-split (string-copy str 0 1) (string-copy str 1 len))))
                 (s2 (and (> len 2)
                          (SI:try-split (string-copy str 0 2) (string-copy str 2 len))))
    ...
    (define si:conversion-factor SI:conversion-factor)
