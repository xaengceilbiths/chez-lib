        ...
        (and command:get
             (letrec ((wdb (lambda (command)
                             (let ((com (command:get command)))
                               (if com ((eval com) wdb) (rdb command))))))
