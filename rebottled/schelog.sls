#!chezscheme
;; r6rs Scheme version of Schelog, June 2010
;; r7rs port by Peter Lane, 2017 
;; Note, made '!' a parameter so identifier can be exported
...
(library
  ...
  (begin
    ...
    ;some utilities, in Prolog-like fashion.
